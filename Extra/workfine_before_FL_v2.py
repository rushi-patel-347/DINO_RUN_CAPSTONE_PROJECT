...
cloud = [pygame.image.load(os.path.join("Assets/Other", "Cloud.png")),
         pygame.image.load(os.path.join("Assets/Other/Clouds", "Cloud1.png")),
         pygame.image.load(os.path.join("Assets/Other/Clouds", "Cloud2.png"))]
...
class Cloud:
    def __init__(self,img=cloud):
        for read_img in img:
            self.x = screen_width + random.randint(80, 1000)
            self.y = random.randint(50, 100)
            self.image = read_img
            self.width = self.image.get_width()
            
            
            # self.x = screen_width + random.randint(210, 500)
            # self.y = random.randint(100, 200)
            # self.image = read_img
            # self.width = self.image.get_width()

            #bottom
            # self.x = screen_width + random.randint(40, 200)
            # self.y = random.randint(210, 280)
            # self.image = read_img
            # self.width = self.image.get_width()

    # def draw_cloud(self,img=cloud):        
    #     for read_img in img:
    #         self.x = screen_width + random.randint(80, 1000)
    #         self.y = random.randint(50, 100)
    #         self.image = read_img
    ...
    def update(self):
        ...
        # self.x -= game_speed
        # if self.x < -self.width:
        #     self.x = screen_width + random.randint(500, 2400)
