...
def eval_genomes(genomes, config):
    ...
    def score():
        ...
        screen.blit(text1,(750, 50)) #blit()=copy the contents of one Surface onto another Surface 
    ...
    while run:
        ...
        if(flag_high_score==False and len(dinosaurs)==0):
            #open file
            file = open("../TEMP_High_Score.txt", "r")
            ...
            if(high_score_in_file<points):
                ...
                file = open("../TEMP_High_Score.txt", "w")
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.KEYDOWN:
                ...
                if __name__ == '__main__':
                    if os.path.getsize("../TEMP_High_Score.txt") == 0: 
                        f=open("../TEMP_High_Score.txt","w")
                        f.write("0")
                        f.close()
                        print("file is empty")
